...
# post_example = {"post_id":"23jdidubd7cb2x","op_id":"12D32423kbJKH9","ts":"Mon Dec 05 2022 19:36:56 GMT-0600 (Central Standard Time)","location":"Chem lib","content":"Trying out comment insertions","comments":[]}
# resp = requests.post('http://localhost:5000/insert/Posts', json=json.dumps(post_example), headers={"Content-Type": "application/json"})
# print(resp.text, ", ", resp.status_code)

comment_example = {"user_id":"1685736281929","ts":"Sun Dec 04 2022 13:52:01 GMT-0600 (Central Standard Time)","content":"Lets study for 233!"}
